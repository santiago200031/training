...
import org.deeplearning.exceptions.SaveModelException;
...
public class BTCAIModel implements AIModel {
    ...
    @ConfigProperty(name = "resources.btc.neural-network.model")
    private String neuralNetworkFile;
    @ConfigProperty(name = "resources.btc.neural-network.best-model")
    private String bestNeuralNetworkModelFile;
    @ConfigProperty(name = "resources.btc.neural-network.chart-file")
    ...
    public void saveModel(String filePath) {
        ...
        try {
            ...
            throw new SaveModelException(e, filePath);
        }
    }
}